class Article < ActiveRecord::Base
	...
	def self.get(feed_id)
		...
		# search SEARCH API
		news = HTTParty.get("http://api.nytimes.com/svc/search/v2/articlesearch.json?q=#{search}&api-key=3f3aa28df973fe380ccc48691770dee4:11:65256769")
